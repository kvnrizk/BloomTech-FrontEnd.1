...
<a href='my-account.php'>View Updated Record</a>";
...
<p><input type="text" name="firstName" placeholder="Enter your First Name" 
required value="<?php echo $row['firstName'];?>" /></p>
<p><input type="text" name="lastName" placeholder="Enter your Last Name" 
